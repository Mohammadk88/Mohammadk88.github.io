                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-ku">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title_ku" class="form-control" value="{{ old('title_ku', $project->title_ku) }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">وەسف (کوردی)</label>
                            <textarea name="description_ku" class="form-control" rows="5">{{ old('description_ku', $project->description_ku) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">شوێن (کوردی)</label>
                            <input type="text" name="location_ku" class="form-control" value="{{ old('location_ku', $project->location_ku) }}">
                        </div>
                    </div>
                </div>
            </div>
...
document.getElementById('addFeature').addEventListener('click', function() {
    ...
    row.innerHTML = `
        <div class="col-md-4"><input type="text" name="features[${featureCount}][ar]" class="form-control form-control-sm" placeholder="عربي"></div>
        <div class="col-md-4"><input type="text" name="features[${featureCount}][en]" class="form-control form-control-sm" placeholder="English"></div>
